...
class genDiffTest extends TestCase
{
    ...
    //     $file1 = 'simple10.json';
    //     $file2 = 'simple20.json';
    //     print_r(getTestFilePath($file1), getTestFilePath($file2));
    // }
    ...
    //     $file1 = 'deep1.json';
    //     $file2 = 'deep2.json';
    //     print_r(genDiff(getTestFilePath($file1), getTestFilePath($file2)));
    // }
    ...
    public function testGetDiffDeepJsonToPlain()
    {
        ...
        print_r(genDiff(getTestFilePath($file1), getTestFilePath($file2), 'plain'));
